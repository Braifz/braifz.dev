...
summary: "Next.js introduce Cache Components, una nueva forma de cachear componentes en tu aplicación."
date: Feb 5, 2026
author: "Braifz"
...
- Acceder a cookies() o headers() dentro de un componente que usa "use cache".
